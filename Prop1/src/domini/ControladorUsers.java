...
//CREADORA	
	 ...
	 * Post: hi ha un conjunt d'usuaris que conté els usuaris existents en el registre
	 */
	public ControladorUsers() {
		// TODO Auto-generated constructor stub
		conj = new ConjuntUsuaris();
		/*
		DadesUser du = new DadesUser();
		du.carregarUsers();
		*/
	}
//MODIFICADORES	
	...
	/**
	 * Pre: cert
	 * Post: Es retorna cert si l'usuari s'ha pogut crear satisfactoriament i s'afegeix un usari amb les dades corresponents o es retorna fals si no s'ha pogut crear
	 * @return
	 */
...
//CONSULTORES	
	 ...
	 * Post: no modifica les dades
	 * @return cert si les dades son correctes i corresponen a un usuari existent o fals en cas contrari
	 */
	...
	public ArrayList<String> getUsers(){
		...
		while(itset.hasNext())llista.add(itset.next());
		return llista;
	}
