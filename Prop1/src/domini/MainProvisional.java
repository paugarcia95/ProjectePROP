 ...
 * 
		...
		System.out.println(" ");
		System.out.print("Numero d'opci�:");
		int n = 0;
		n = s.nextInt();
		while(true) {
			switch(n) {
 ...
 */
	...
	private static void visualitzarCategoria(String quina){
		System.out.println("Funci� no acabada d'implementar, encara no es pot navegar per la resta de Categories o Pagines ");
	...
	private static void visualitzarPagina(String quina) {
		System.out.println("Funci� no acabada d'implementar, encara no es pot navegar per la resta de Categories ");
	...
	private static void modificaCriterisConjuntComunitats(Integer cercaactual) {
		...
		System.out.println("Atencio! Si es fa servir el criteri de triar un subconjunt de categories, nomes es tindran en compte, a mes a mes, els criteris de relacio i semblan�a ");
		...
		while(omplint) {
			...
			case 1:
				tipus = 1;
				System.out.println("Digues amb un numero del 0 al 100, la dispersi� desitjada");
				dada = s.nextInt();
				omplint = false;
				break;
			case 2:
				...
				System.out.println("Tria entre les seguents opcions:");
				System.out.println("1. Buscar a partir de la dispersi�: ");
				...
				while(!fet) {
					...
					case 1:
						tipus = 1;
						System.out.print("Digues amb un numero del 0 al 100, la dispersi� desitjada: ");
						dada = s.nextInt();
						fet = true;
						break;
					case 2:
		...
		System.out.println("Comen�a la Cerca de Comunitats, aquest proc�s pot tardar uns minuts, si us plau, tingues paciencia");
...
//OPCIONS ADMIN	
	...
	private static void esborraDades(){
		...
		System.out.println("Segur que vols eliminar????? Aquesta acci� �s irreversible i deixa el sisteme sense categories ni p�gines");
	...
	private static void introduirDesDeFitxer() {System.out.println("Funci� no implementada encara ");}
	...
	private static void introduirDades() {
		...
		System.out.println("Tria entre les seguents opcions:");
		System.out.println("1. Introduir dades a partir de fitxer d'enlla�os ");
		...
		System.out.println("4. Introduir enlla� manualment (NO IMPLEMENTAT)");
		System.out.println("5. Enrere ");
		System.out.print("Numero d'opci�:");
		int n = 0;
		n = s.nextInt();
...
//OPCIONS CLIENT + ADMIN	
	private static void buscaEntreCategoriesAdmin() {
		System.out.println("Funci� no acabada d'implementar encara, ara per ara nom�s mostra les categories existents i en pots visualitzar ");
		//Quan estigui fet el ControladorAdminsUsers, ho far� des d'all�
	...
	private static void buscaEntreCategoriesClient() {
		System.out.println("Funci� no acabada d'implementar encara, ara per ara nom�s mostra les categories existents ");
		//Quan estigui fet el ControladorAdminsUsers, ho far� des d'all�
		Collection<Categoria> aux = mc.getGraf().getCategories();
		Iterator<Categoria> it = aux.iterator();
		while(it.hasNext()) System.out.println(it.next().getNom());
	...
	private static void buscarEntreCategoriesPaginesAdmin() {
		System.out.println("Funci� no acabada d'implementar encara, ara per ara nom�s mostra les categories i pagines existents ");
	...
	private static void buscarEntrePaginesAdmin() {
		System.out.println("Funci� no acabada d'implementar encara, ara per ara nom�s mostra les pagines existents ");
		//Quan estigui fet el ControladorAdminsUsers, ho far� des d'all�
	...
	private static void crearConjuntComunitats() {
		...
		System.out.println("Indica amb un numero del 0 al 10 la importancia que li vols donar als seguents criteris: ");
		System.out.println("Atencio! Si es fa servir el criteri de triar un subconjunt de categories, nomes es tindran en compte, a mes a mes, els criteris de relacio i semblan�a ");
		System.out.println("Atencio! Si es fa servir el criteri de triar una paraula clau, nomes es tindran en compte, a mes a mes, els criteris d'ignorar, de relacio i semblan�a ");
		System.out.println("Atencio! Si es fa servir el criteri de triar una categoria pare, nomes es tindran en compte, a mes a mes, els criteris d'ignorar, de relacio i semblan�a ");
		Integer relacions, sembla, alg, tipus, paraulain, dada;
		ArrayList<String> subconj, evitaCat, evitaPag;
		String pare, paraulast;
		...
		System.out.print("Importancia en la semblan�a de nom de les categories, sent 0 a no donar-li importancia a que els noms s'assemblin i 10 que es premi� molt que s'assemblin");
		sembla = s.nextInt();
	...
	public static void main(String[] args) {
		...
		System.out.println("Acabes d'entrar al main provisional del projecte de la Wikipedia, es mostraran les mateixes funcionalitats que en el projecte final per� en mode consola.");
		...
		System.out.println("Per Poder visualitzar alguna categoria o p�gina, provisionalment, has d'entrar com a admin");
		System.out.println("Com que falta el controladorAdminsUsers, la implementacio de les funcionalitats que han d'anar a traves seu es fan directament des del main o el macrocontrolador, aix� es provisional");
